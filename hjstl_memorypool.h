...
* Author:hujian
* Time:2016/4/20
* discription:this file is about memory pool.
*
*/
...
__HJSTL_PUBLIC_://you can use this api in your project
	...
	//if the memory bigger max-align,call first levle's allocate to handle it.
	static void* hjstl_allocate(size_t sz)
	{
		...
		result = *my_free_list;
		if (0 == result){//no,this size's free list is empty,ok,re-fill it<default-nodes>
